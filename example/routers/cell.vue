<template>
    ...
    <hui-layout title="Cell">
        ...
        <hui-cell-group title="带图标的">
            <hui-cell-item>
                <i slot="icon" class="demo-icons-phone"></i>
                <input slot="right" type="number" pattern="[0-9]*" placeholder="请输入手机号码" autocomplete="off">
                <hui-button slot="right" type="warning">获取短信验证码</hui-button>
            </hui-cell-item>

            <hui-cell-item href="#" type="link">
                <i slot="icon" class="demo-icons-like"></i>
                <span slot="left">我的收藏</span>

                <span slot="right"><hui-badge type="danger">8</hui-badge></span>
            </hui-cell-item>

            <hui-cell-item arrow href="tel:400-888-8888" type="a">
            ...
            <hui-cell-item href="#" arrow type="link">
                <img slot="icon" src="http://static.ydcss.com/hui/img/logo.png">
        ...
        <hui-cell-group title="多选">
            <hui-cell-item type="checkbox">
        ...
        <hui-cell-group title="单选">
            <hui-cell-item type="radio">
        ...
        <hui-cell-group title="复选框">
            <hui-cell-item type="label">
                <div slot="left">设为默认地址 - {{ydswitch}}</div>
                <hui-switch slot="right" v-model="ydswitch"></hui-switch>
            </hui-cell-item>
        </hui-cell-group>

        <hui-cell-group title="文本域">
            <hui-cell-item>
                <hui-textarea slot="right" placeholder="请输入您的银行卡卡号和密码" maxlength="100"></hui-textarea>
            </hui-cell-item>
        </hui-cell-group>
