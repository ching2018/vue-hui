<template>
    <hui-layout>
        <h1 class="demo-logo"><img src="http://static.ydcss.com/hui/img/logo.png"></h1>
        <h2 class="demo-detail-title">一只基于Vue2.x的移动端&微信UI。 -HUI Touch</h2>

        <hui-grids-group rows="4">
            <hui-grids-item v-for="item in list" :link="item.link">
