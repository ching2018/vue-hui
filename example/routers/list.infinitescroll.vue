<template>
    <hui-layout>
        ...
        <hui-navbar slot="navbar" title="InfiniteScroll">
            <router-link to="/list" slot="left">
                <hui-navbar-back-icon></hui-navbar-back-icon>
            </router-link>
        </hui-navbar>

        <hui-infinitescroll :on-infinite="loadList" ref="lsdemo">
            ...
            <!-- 加载中提示 -->
            <img slot="loadingTip" src="http://static.ydcss.com/uploads/hui/loading/loading10.svg"/>
