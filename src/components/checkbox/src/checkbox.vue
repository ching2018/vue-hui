<template>
    <label class="hui-checkbox" :class="shape == 'circle' ? 'hui-checkbox-circle' : ''">
        <template v-if="group">
        ...
        <span class="hui-checkbox-icon" :style="iconStyles()"><i :style="checkIconStyles()"></i></span>

        <template v-if="!$slots.default">
            <span class="hui-checkbox-text">{{val}}</span>
        </template>
        <template v-else>
            <span class="hui-checkbox-text"><slot></slot></span>
        </template>
    </label>
</template>
