<template>
    <div>
        ...
        <div class="hui-list-loading" v-if="!isDone">
        ...
        <div class="hui-list-donetip" v-show="!isLoading && isDone">
    ...
    export default {
        ...
        methods: {
            init() {
                ...
                this.$on('hui.infinitescroll.loadedDone', () => {
                    this.isLoading = false;
                    this.isDone = true;
                });

                this.$on('hui.infinitescroll.finishLoad', (ret) => {
                    this.isLoading = false;
                });

                this.$on('hui.infinitescroll.reInit', () => {
                    this.isLoading = false;
                    this.isDone = false;
                });
            },
