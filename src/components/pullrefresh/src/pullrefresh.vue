<template>
    <div>
        ...
        <div class="hui-pullrefresh-draghelp" v-if="showHelpTag" @click="showHelpTag = false">
    ...
    export default {
        ...
        methods: {
            ...
            touchEndHandler(event) {
                ...
                this.dragTip.animationTiming = 'hui-pullrefresh-animation-timing';

                if (touches.moveOffset >= this.dragTip.distance) {
                    this.dragTip.statusText = this.loadingText;
                    this.dragTip.loadingIcon = 'hui-pullrefresh-loading';
                    this.triggerLoad();
                    return;
                }
