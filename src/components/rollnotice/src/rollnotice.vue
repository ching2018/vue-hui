<template>
    <div class="hui-rollnotice" :style="{height: height + 'px'}">
        <div class="hui-rollnotice-box" :style="styles" :class="'hui-rollnotice-align-' + align">
            <div class="hui-rollnotice-item" v-html="lastItem"></div>
            <slot></slot>
            <div class="hui-rollnotice-item" v-html="firtstItem"></div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            init() {
                ...
                this.items = this.$children.filter(item => item.$options.name === 'hui-rollnotice-item');
